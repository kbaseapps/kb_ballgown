SERVICE = kb_ballgown
SERVICE_CAPS = kb_ballgown
SPEC_FILE = kb_ballgown.spec
URL = https://kbase.us/services/kb_ballgown
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
...
build-test-script:
	...
	echo 'coverage report --rcfile=.coveragerc -m' >> $(TEST_DIR)/$(TEST_SCRIPT_NAME)
	...
	echo 'cp -R /kb/module/lib/kb_ballgown/ /kb/module/work/kb/module/lib/' >> $(TEST_DIR)/$(TEST_SCRIPT_NAME)
