...
function kb_ballgown(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_ballgown_app = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_ballgown.run_ballgown_app",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_ballgown.status",
