...
class BallgownUtil:
    ...
    def _generate_html_report(self, result_directory, diff_expression_obj_ref, params):
        """
    ...
    def save_output(self,ws_id,
        ...
        """
        Takes the output_csv generated by run_ballgown_diff_exp() and loads it into
        ...
        :param conditions: 
        :param genome_id: 
        :param expressionset_id: 
        :param alignmentset_id: 
        :param sampleset_id: 
        :param output_object_name: 
        :return: 
        """

        shock_id = self.dfu.file_to_shock({'file_path': ballgown_output_dir,
                                                  'pack': 'zip'})['shock_id']

        # create object
        de_obj = {"tool_used": 'Ballgown',
                  "tool_version": '',
        ...
        objs_save_data =  self.ws.save_objects(
            {"workspace": ws_id,
             "objects": [
                 {
