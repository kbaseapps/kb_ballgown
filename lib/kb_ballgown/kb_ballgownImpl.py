...
class kb_ballgown:
    ...
    GIT_COMMIT_HASH = "4fbc95f338788bb5f05f1955e7b9d883283af7d0"
    ...
    def run_ballgown_app(self, ctx, params):
        ...
        :param params: instance of type "BallgownInput" (required params:
           ...
           KBaseSets.DifferetialExpressionMatrixSet name condition_labels:
           conditions for expression set object alpha_cutoff: q value cutoff
           fold_change_cutoff: fold change cutoff num_threads: number of
           threads workspace_name: the name of the workspace it gets saved to
           optional params: maximum_num_genes: used to filter genes in the
           differential expression matrix fold_scale_type: one of ["linear",
           "log2+1", "log10+1"]) -> structure: parameter "expressionset_ref"
           of type "obj_ref" (An X/Y/Z style reference), parameter
           "diff_expression_matrix_set_suffix" of String, parameter
           ...
           parameter "maximum_num_genes" of Long, parameter "fold_scale_type"
           of String
